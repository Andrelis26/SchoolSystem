...
namespace SchoolSystem.Controllers
{
    ...
    public class RegistroesController : Controller
    {
        ...
        {
            var registro = db.Registro.Include(r => r.Estudiante);
        ...
        public ActionResult Create([Bind(Include = "ID_Registro,ID_Estudiante,Usuario,Contraseña,Rol")] Registro registro)
        {
            ...
            ViewBag.ID_Estudiante = new SelectList(db.Estudiante, "ID_Estudiante", "Primer_Nombre", registro.ID_Estudiante);
            return View(registro);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Registro,ID_Estudiante,Usuario,Contraseña,Rol")] Registro registro)
        {
            if (ModelState.IsValid)
            {
