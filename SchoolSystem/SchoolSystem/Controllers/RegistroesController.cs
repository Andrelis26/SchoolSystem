...
namespace SchoolSystem.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Registro,ID_Estudiante,Usuario,Contraseña")] Registro registro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Registro,ID_Estudiante,Usuario,Contraseña")] Registro registro)
        {
            if (ModelState.IsValid)
            {
